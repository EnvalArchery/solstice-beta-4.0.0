...
import me.nullrush.solstice.mixins.accessors.NativeImageAccessor;
...
public class GlyphMap {
    ...
    public GlyphMap(Font[] fonts, char include, char exclude, int padding, boolean antiAliasing, boolean fractionalMetrics) {
        this.fonts = fonts;
