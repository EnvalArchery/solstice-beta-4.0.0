...
import me.nullrush.solstice.mixins.accessors.ClientPlayerEntityAccessor;
...
public class SprintModule extends Module {
    ...
    public boolean shouldSprint() {
        ...
        if (mode.getValue().equalsIgnoreCase("Rage")) {
            ...
            if (mc.player.isUsingItem() && (!Solstice.MODULE_MANAGER.getModule(NoSlowModule.class).isToggled() || !Solstice.MODULE_MANAGER.getModule(NoSlowModule.class).items.getValue())) return false;
