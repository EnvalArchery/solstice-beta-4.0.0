...
import me.nullrush.solstice.mixins.accessors.ClientPlayerInteractionManagerAccessor;
...
public class MaceAuraModule extends Module {
    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        ...
        if(rotate.getValue()) Solstice.ROTATION_MANAGER.rotate(RotationUtils.getRotations(target), this);
