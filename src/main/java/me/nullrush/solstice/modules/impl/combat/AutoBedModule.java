...
import me.nullrush.solstice.utils.minecraft.*;
...
public class AutoBedModule extends Module {
    ...
    private void placeBed(BlockPos pos, Direction direction, Direction rotation) {
        if(rotate.getValue()) Solstice.ROTATION_MANAGER.rotate(RotationUtils.getRotations(pos.toCenterPos()), this);

        Solstice.ROTATION_MANAGER.packetRotate(RotationUtils.getRotations(rotation));
