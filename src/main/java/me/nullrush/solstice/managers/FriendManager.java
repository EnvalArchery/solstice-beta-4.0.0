...
public class FriendManager {
    ...
    public boolean getFriendFire() {
        return Solstice.MODULE_MANAGER.getModule(FriendModule.class).friendlyFire.getValue();
    }

    public void sendFriendMessage(String name) {
        Solstice.MODULE_MANAGER.getModule(FriendModule.class).sendFriendMessage(name);
    }
