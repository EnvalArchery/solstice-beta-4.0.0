...
public class    MacroManager implements IMinecraft {
    ...
    public void onKeyInput(KeyInputEvent event) {
        ...
        for (String key : macros.keySet()) {
            ...
            if (key == null) {
                Solstice.CHAT_MANAGER.error("An error happened while executing the " + ChatUtils.getPrimary() + KeyboardUtils.getKeyName(value) + ChatUtils.getSecondary() + " macro.");
                continue;
            }
            ...
            for (String str : split) {
                if (str.startsWith("/")) {
                    ...
                    if (str.startsWith(Solstice.COMMAND_MANAGER.getPrefix())) {
                        Solstice.COMMAND_MANAGER.execute(str);
                    } else {
