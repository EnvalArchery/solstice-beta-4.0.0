...
public class ColorButton extends Button {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if(open) {
            ...
            Solstice.FONT_MANAGER.drawTextWithShadow(context, "Copy", getX() + getPadding() + (getWidth()/4) - 1 - Solstice.FONT_MANAGER.getWidth("Copy")/2, getY() + offset + 2, Color.WHITE);
            ...
            Solstice.FONT_MANAGER.drawTextWithShadow(context, "Paste", getX() + (getWidth()/2) + (getWidth()/4) - 1 - Solstice.FONT_MANAGER.getWidth("Paste")/2, getY() + offset + 2, Color.WHITE);
            ...
            Solstice.FONT_MANAGER.drawTextWithShadow(context, "Sync", getX() + (getWidth()/2) - Solstice.FONT_MANAGER.getWidth("Sync")/2, getY() + offset + 2, Color.WHITE);
            ...
            Solstice.FONT_MANAGER.drawTextWithShadow(context, "Rainbow", getX() + (getWidth()/2) - Solstice.FONT_MANAGER.getWidth("Rainbow")/2, getY() + offset + 2, Color.WHITE);
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if(button == 0) {
            ...
            if(hoveringCopy) {
                Solstice.CLICK_GUI.setColorClipboard(setting.getValue().getColor());
                playClickSound();
            }
            if(hoveringPaste && Solstice.CLICK_GUI.getColorClipboard() != null) {
                setting.setColor(Solstice.CLICK_GUI.getColorClipboard());
                hsb = Color.RGBtoHSB(setting.getColor().getRed(), setting.getColor().getGreen(), setting.getColor().getBlue(), null);
                playClickSound();
            }
            if(setting != Solstice.MODULE_MANAGER.getModule(ColorModule.class).color && hoveringSync) {
